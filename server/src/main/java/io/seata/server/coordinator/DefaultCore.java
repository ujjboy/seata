...
public class DefaultCore implements Core {
    ...
    private GlobalSession assertGlobalSession(long transactionId, GlobalStatus status) throws TransactionException {
        ...
        if (!globalSession.isActive()) {
            throw new TransactionException(TransactionExceptionCode.GlobalTransactionNotActive, "Current Status: " + globalSession.getStatus());
        }
        if (globalSession.getStatus() != status) {
            throw new TransactionException(TransactionExceptionCode.GlobalTransactionStatusInvalid,
