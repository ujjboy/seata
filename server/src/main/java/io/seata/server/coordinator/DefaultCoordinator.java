...
public class DefaultCoordinator extends AbstractTCInboundHandler
    ...
    public BranchStatus branchCommit(BranchType branchType, String xid, long branchId, String resourceId,
        ...
        try {
            ...
            throw new TransactionException(TransactionExceptionCode.FailedToSendBranchCommitRequest, branchId + "/" + xid, e);
    ...
    public BranchStatus branchRollback(BranchType branchType, String xid, long branchId, String resourceId,
        ...
        try {
            ...
            throw new TransactionException(TransactionExceptionCode.FailedToSendBranchRollbackRequest, branchId + "/" + xid, e);
        } catch (TimeoutException e) {
            throw new TransactionException(TransactionExceptionCode.FailedToSendBranchRollbackRequest, branchId + "/" + xid, e);
        }
    }
